...
class SeasonProjectedStatsViewer:
    ...
    def display(self, prefix=""):
        ...
        if all(col in self.df.columns for col in required_columns):
            ...
            display_df = aggregated_df[['Manager', 'year', 'win', 'loss', 'team_points', 'opponent_score', 'team_projected_points', 'opponent_projected_points', 'Expected Odds', 'margin', 'Expected Spread', 'Projected Wins', 'Above Projected Score', 'Win Matchup Against the Spread', 'Projected Score Error', 'Absolute Value Projected Score Error']]
