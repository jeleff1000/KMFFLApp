...
class SeasonAdvancedStatsViewer:
    ...
    def display(self, prefix=""):
        ...
        if missing_columns:
            ...
            display_df = display_df[['Manager', 'year', 'win', 'loss', 'team_points', 'opponent_score', 'margin', 'weekly_mean', 'weekly_median', 'total_matchup_score', 'teams_beat_this_week', 'opponent_teams_beat_this_week', 'close_margin', 'above_league_median', 'below_league_median', 'Above Opponent Median', 'Below Opponent Median', 'GPA', 'League-Wide Season Mean', 'League-Wide Season Median', 'Personal Season Mean', 'Personal Season Median', 'Winning Streak', 'Losing Streak', 'Real Score', 'Real Opponent Score', 'Real Margin', 'Real Total Matchup Score']]
