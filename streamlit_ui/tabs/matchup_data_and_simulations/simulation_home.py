...
from .playoff_odds import PlayoffOddsViewer  # Import your simulation
    ...
    def display(self):
        ...
        with col1:
            simulation_type = st.selectbox("Select Simulation Type", [
                "", "Playoff Odds", "Gavi Stat", "Opponent Gavi Stat", "Everyone's Schedule",
        ...
        if simulation_type and self.matchup_data_df is not None:
            ...
            if simulation_type == "Playoff Odds":
                viewer = PlayoffOddsViewer(self.matchup_data_df)
