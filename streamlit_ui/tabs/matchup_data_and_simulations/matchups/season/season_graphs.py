...
class SeasonMatchupStatsViewer:
    ...
    def display(self, prefix=""):
        ...
        if self.df is not None and required_cols.issubset(self.df.columns) and not self.df.empty:
            ...
            df_sorted['Cumulative Team Points'] = df_sorted.groupby('Manager')['team_points'].cumsum()
            ...
            st.write("Required columns ('Manager', 'week', 'team_points') are missing or DataFrame is empty.")
