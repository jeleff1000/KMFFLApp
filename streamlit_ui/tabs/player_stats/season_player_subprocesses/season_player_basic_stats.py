...
def get_basic_stats(player_data, position):
    if position in ['QB']:
        columns = ['player', 'team', 'season', 'owner', 'points', 'position', 'Pass Yds', 'Int Pass TD', 'Rush Yds', 'Rush TD']
    elif position in ['RB', 'W/R/T']:
        columns = ['player', 'team', 'season', 'owner', 'points', 'position', 'Rush Yds', 'Rush TD', 'Rec Yds', 'Rec TD']
    elif position in ['WR']:
        columns = ['player', 'team', 'season', 'owner', 'points', 'position', 'Rec Yds', 'Rec TD', 'Rush Yds', 'Rush TD']
    elif position in ['K']:
