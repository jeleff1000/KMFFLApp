...
def get_basic_stats(player_data, position):
    if position in ['QB']:
        columns = ['player', 'team', 'owner', 'points', 'position', 'Pass Yds', 'Pass TD', 'Int', 'Rush Yds', 'Rush TD']
    elif position in ['RB', 'W/R/T']:
        columns = ['player', 'team', 'owner', 'points', 'position', 'Rush Yds', 'Rush TD', 'Rec', 'Rec Yds', 'Rec TD']
    elif position in ['WR', 'TE']:
        columns = ['player', 'team', 'owner', 'points', 'position', 'Rec', 'Rec Yds', 'Rec TD', 'Rush Yds', 'Rush TD']
    elif position in ['K']:
